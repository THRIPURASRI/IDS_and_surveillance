...
def process_frame():
    ...
    cv2.imwrite("C:/Users/thrip/OneDrive/Documents/web_app/captured_frame.jpg", frame)

    # Load and save the registered user image
    user_image = cv2.imread(user.image_path)
    cv2.imwrite("C:/Users/thrip/OneDrive/Documents/web_app/registered_user.jpg", user_image)
